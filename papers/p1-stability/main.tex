% =============================================================================
% RCS Paper 1 --- Empirical Stability Budget in a Production Agent OS
...
\date{April 2026 --- Scaffold Draft}
...
of this series. Using the Life Agent OS as the experimental
plant, we estimate the per-level margin $\hat{\stab}_i$ and composite
rate $\hat{\omega}_N = \min_i \hat{\stab}_i$ from OpenTelemetry
...
% Theorem~\ref{thm:recursive} (proved in Paper~0).
% No new proofs here; forward all details to Paper~0.
...
%   \ref{sec:methodology}.1 System under test (Life Agent OS deployment)
%   \ref{sec:methodology}.2 Instrumentation (StabilityBudget, MarginEstimator, vigil gauges)
%   \ref{sec:methodology}.3 Data capture (sampling rate, window length, run matrix)
%   \ref{sec:methodology}.4 Dataset layout (\texttt{data/p1-runs/})
...
% =============================================================================
% TODO(P1f): summary; limitations; threads to Papers 2--4 (EGRI
% observers, fleet composition).
