...
and is directly analogous to the time-scale separation underpinning
Theorem~\ref{thm:recursive}'s $\omega_N > 0$ composition.  That a
3B-parameter deployed model required an explicit insulation mechanism
to generalise corroborates the prediction of (H6)--(H7): without
level separation, lower-level adaptation destabilises higher-level
representations regardless of state-space choice.
